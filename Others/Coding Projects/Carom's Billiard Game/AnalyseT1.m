...
BorderWinColor = [100 255 0
];
BorderLossColor = [255 0 0
];
LineStyle = '-';
BorderHitStyle = 'o';
MarkerStyle = '.';
...
plot(Xr,Yr,[LineStyle, 'r'],'Marker',MarkerStyle,'MarkerFaceColor','r')
plot(Xy,Yy,[LineStyle, 'y'],'Marker',MarkerStyle,'MarkerFaceColor','y')
plot(Xw,Yw,[LineStyle, 'b'],'Marker',MarkerStyle,'MarkerFaceColor','b')
