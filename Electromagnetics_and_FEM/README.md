...
Two reports are included in this folder:

- **Master Thesis** — 3D FEM simulation of moving Halbach arrays and electromagnets over ferromagnetic rails: eddy current induction, nonlinear B-H curve saturation, skin depth resolution, hybrid EMS design, and force optimisation for a hyperloop levitation and guidance system. *(COMSOL, MATLAB)*
