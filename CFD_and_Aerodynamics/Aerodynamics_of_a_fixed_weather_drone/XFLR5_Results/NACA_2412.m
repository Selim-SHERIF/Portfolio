...
title('Lift curve : TAT NACA 2412');
...
xticks(xL(1):10:xL(2));
yticks(yL(1):0.5:yL(2));
title('Lift curve : NUM NACA 2412');
xlabel('Angle of attack : \alpha (in deg)');
ylabel('Lift coefficient : C_l ');
plot([0 0], yL,'k','LineStyle','--','LineWidth',0.25);  %y-axis
plot(xL, [0 0], 'k','LineStyle','--','LineWidth',0.25);  %x-axis
...
title('Drag polar : NUM NACA 2412');
xlabel('Lift coefficient : C_l');
ylabel('Drag coefficient : C_d');
plot([0 0], yL,'k','LineStyle','--','LineWidth',0.25 );  %y-axis
hold off;

%% Expermiental approach
...
xticks(xL(1):10:xL(2));
yticks(-1:0.5:1.5);
title('Lift curve : EXP NACA 2412');
xlabel('Angle of attack : \alpha (in deg)');
ylabel('Lift coefficient : C_l');
plot([0 0], yL,'k','LineStyle','--','LineWidth',0.25);  %y-axis
plot(xL, [0 0], 'k','LineStyle','--','LineWidth',0.25);  %x-axis
...
yL = ylim;
xticks(-1:0.5:1.5);
yticks(yL(1):0.04:yL(2));
title('Drag polar : EXP NACA 2412');
xlabel('Lift coefficient : C_l');
ylabel('Drag coefficient : C_d');
plot([0 0], yL,'k','LineStyle','--','LineWidth',0.25 );  %y-axis
hold off;

%Combined Drag Polar Graph 
figure 
hold on 
Cl=(ExperimentalData.NACA2412)./(0.5*0.395*0.1*23*23*1.1606);
Cd= (ExperimentalData.NACA2412D)./(0.5*0.395*0.1*23*23*1.1606);
...
Cl_a = LC2412.Cl_a;
plot (Alpha,Cl_a,'LineWidth',1.5)
legend('TAT','','','Experimental', 'Numerical')
hold off;
